    ...
    return (
        <div className="auth-container">
            <div className="auth-card">
                ...
                {errorMsg && (
                    <div style={{ backgroundColor: 'rgba(255, 0, 0, 0.1)', color: '#ff4d4f', padding: '0.75rem', borderRadius: '6px', marginBottom: '1rem', textAlign: 'center', fontSize: '0.875rem' }}>
                        {errorMsg}
                    </div>
                )}

                {successMsg && (
                    <div style={{ backgroundColor: 'rgba(0, 255, 102, 0.1)', color: '#00ff66', padding: '0.75rem', borderRadius: '6px', marginBottom: '1rem', textAlign: 'center', fontSize: '0.875rem' }}>
                        {successMsg}
                    </div>
                )}
